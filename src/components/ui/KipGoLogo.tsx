...
export const KipGoLogo = ({ width = 200, height = 60, iconOnly = false }: Props) => {
  ...
  return (
    <Svg width={width} height={height} viewBox={iconOnly ? '0 0 120 120' : '0 0 400 120'}>
      ...
      <Path d="M60 55l40 10-10 10" fill="none" stroke={colors.warning} strokeWidth={8 * scale} strokeLinecap="round" strokeLinejoin="round" />
      {!iconOnly && (
        <SvgText x="130" y="85" fontFamily="Manrope" fontWeight="800" fontSize={72} fill={colors.textPrimary}>
          Kip<TSpan fill={colors.warning}>Go</TSpan>
        </SvgText>
      )}
    </Svg>
  );
